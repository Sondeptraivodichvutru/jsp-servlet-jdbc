                        ...
                        <form action="<c:url value='/admin-product'/>" id="formSubmit"
                            ...
                            <div class="table-data__tool">
                                ...
                                <div class="table-data__tool-right">
                                    ...
                                    <c:url var="deletedProduct" value="/admin-deleted-product">
														<c:param name="type" value="list" />
														<c:param name="page" value="1" />
														<c:param name="status" value="0" />
														<c:param name="maxPageItem" value="6" />
													</c:url>
													<a class="item au-btn au-btn-icon au-btn--green au-btn--small" data-toggle="tooltip" title="View deleted product"
														href='${deletedProduct}'> <i class="zmdi zmdi-more"
														aria-hidden="true"></i>
													</a>
        ...
        function deleteNew(data) {
            $j.ajax({
                ...
                success: function (result) {
                    window.location.href = "${ProductURL}?type=list&maxPageItem=6&page=1&status=1&message=delete_success";
                },
                error: function (error) {
                    window.location.href = "${ProductURL}?type=list&maxPageItem=6&page=1&status=1&message=error_system";
                }
            });
        }
