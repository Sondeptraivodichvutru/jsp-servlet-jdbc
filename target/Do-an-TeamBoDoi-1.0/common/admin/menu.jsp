    ...
    <div class="menu-sidebar__content js-scrollbar1">
        <nav class="navbar-sidebar">
            <ul class="list-unstyled navbar__list">
                ...
                <li><a href="<c:url value='/admin-product?type=list&page=1&maxPageItem=6&sortName=name&sortBy=desc'/>"> <i
                            class="far fa-check-square"></i>Product Manage
                    </a></li>
                <li><a href="<c:url value='/admin-order?type=list&page=1&maxPageItem=6&sortName=createddate&sortBy=desc'/>"> <i
