	...
	<div class="section__content section__content--p30">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<!-- DATA TABLE -->
					<form action="<c:url value='/admin-product-detail'/>" id="formSubmit"
						method="get">												
						...
						<div class="table-data__tool">
							...
							<div class="table-data__tool-right">
								<a flag="info"
									...
									href='<c:url value="/admin-order-detail?type=edit&id=${model.id}"/>'> <span>
										<i class="zmdi zmdi-plus"></i>insert product
								</span>
								</a>
											...
											<td>
												<div class="table-data-feature">
													...
													<a class="item" data-toggle="tooltip" title="Edit"
														...
														aria-hidden="true"></i>
													</a> <a id="btnDelete" class="item" type="button"
