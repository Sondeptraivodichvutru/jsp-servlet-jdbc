                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form id="formSubmit">
                                ...
                                <div class="form-group">
                                    <label class="rs-select2--dark rs-select2--sm rs-select2--dark2">Category</label>
                                    <div class="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="code" name="price" value="${model.price}"
                                           class="form-control"> <span class="help-block"></span>
                                </div>
                                <div class="form-group">
                                    <label for="nf-password" class=" form-control-label">Description</label>
                                    <input type="text" id="code" name="description" value="${model.description}"
                                           class="form-control"> <span class="help-block"></span>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="code" name="image" value="${model.image}"
                                           class="form-control"> <span class="help-block"></span>
                                </div>
                                <div>
        ...
        $
                .ajax({
                    ...
                    success: function (result) {
                        window.location.href = "${NewURL}?type=list&page=1&maxPageItem=6&sortName=name&sortBy=desc&message=insert_success";
                    },
    ...
    function updateNew(data) {
        $
                .ajax({
                    ...
                    dataType: 'json',
                    success: function (result) {
                        window.location.href = "${NewURL}?type=list&page=1&maxPageItem=6&sortName=name&sortBy=desc&message=update_success";
                    },
                    error: function (error) {
                        window.location.href = "${NewURL}?type=list&maxPageItem=6&page=1&message=error_system";
                    }
